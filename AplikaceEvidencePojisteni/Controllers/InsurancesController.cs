...
namespace AplikaceEvidencePojisteni.Controllers
{
    public class InsurancesController : Controller
    {
        ...
        public async Task<IActionResult> Create(int userId, [Bind("InsuranceId,InsuranceType,Subject,Amount,ValidFrom,ValidUntil")] Insurance insurance)
        {
            ...
            {
                // Set the UserId based on the parameter
        ...
        public async Task<IActionResult> Edit(int id, [Bind("InsuranceId,InsuranceType,Subject,Amount,ValidFrom,ValidUntil")] Insurance insurance)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    // Detach the existing insurance entity
                    ...
                    // Set the UserId based on the existing insurance entity
                    insurance.UserId = existingInsurance?.UserId ?? 0; // Perform explicit conversion from int? to int
                ...
                // Redirect to the User Details view
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            int userId = insurance.UserId; // Store the UserId before deleting the insurance
